...
const MyAccount = () => {
  ...
  return (
    <>
      <Breadcrumb title={"Meu Perfil"} pages={["meu perfil"]} />
      ...
      <section className="overflow-hidden py-20 bg-gray-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
              ...
              <div className="flex xl:flex-col">
                <div className="hidden lg:flex flex-wrap items-center gap-5 py-6 px-4 sm:px-7.5 xl:px-9 border-r xl:border-r-0 xl:border-b border-gray-3">
                  ...
                  <div>
                    ...
                    <p className="text-custom-xs">Membro desde 2025</p>
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-7.5 xl:p-9">
                  <div className="flex flex-wrap xl:flex-nowrap xl:flex-col gap-4">
                    ...
                    <button
                      onClick={() => setActiveTab("account-auth")}
                      className={`flex items-center rounded-md gap-2.5 py-3 px-4.5 ease-out duration-200 hover:bg-blue hover:text-white ${activeTab === "account-auth"
                        ? "text-white bg-blue"
                        : "text-dark-2 bg-gray-1"
                        }`}
                    >
                ...
                <div className="bg-white shadow-1 rounded-xl p-4 sm:p-8.5">
                  <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                    <div className="w-full">
                      <label htmlFor="name-user" className="block mb-2.5">
                    ...
                    <div className="w-full">
                      <label htmlFor="lastName-user" className="block mb-2.5">
                  ...
                  <div className="mb-5">
                    <label htmlFor="email-user" className="block mb-2.5">
                      E-mail
                    </label>
                  ...
                  <div className="mb-5">
                    <label htmlFor="phone-user" className="block mb-2.5">
                      Telefone
                    </label>
          ...
          <!-- auth tab content start --> */}
            <div
              className={`xl:max-w-[770px] w-full ${activeTab === "account-auth" ? "block" : "hidden"
                }`}
            >
              <form>
